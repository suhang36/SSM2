...
public class MyBatisTest {
    ...
    public void queryForParam() {
        ...
        List<Map> list = sqlSession.selectList("UserMapper.findUserParameter",params);
        System.out.println("list = " + list);
    }
    public void queryForAll(){
        LOGGER.info("开始执行queryForAll方法");
        sqlSession = build.openSession();
        List<Map> list = sqlSession.selectList("UserMapper.findUser","苏航");
        System.out.println("list = " + list);
        sqlSession.close();
    }
    public void queryForClass(){
        ...
        sqlSession = build.openSession();
        List<Object> list = sqlSession.selectList("UserMapper.findClass", user);
    ...
    public void queryForUser(){
        ...
        sqlSession = build.openSession();
        try {
            users = sqlSession.selectList("UserMapper.findClassForUser", user);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            sqlSession.close();
    ...
    public void selUser(){
        ...
        user.setName("su");
        try {
            users = sqlSession.selectList("UserMapper.selectUser",user);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            sqlSession.close();
    ...
    public void selStudent(){
        ...
        try {
            list = sqlSession.selectList("UserMapper.unionUser");
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            sqlSession.close();
    ...
    public void selStudent2(){
        ...
        List<Student> list = null;
        try {
            list = sqlSession.selectList("UserMapper.selectStudent3",1);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            sqlSession.close();
    ...
    public void dynamicIfSql(){
        ...
        List<User> list = null;
        try {
            list = sqlSession.selectList("UserMapper.dynamicIfSql",user);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            sqlSession.close();
    ...
    public void dynamicIfSql2(){
        ...
        List<User> list = null;
        try {
            list = sqlSession.selectList("UserMapper.dynamicIfSql2",user);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            sqlSession.close();
    ...
    public void dynamicIfSql3(){
        ...
        List<User> list = null;
        try {
            list = sqlSession.selectList("UserMapper.dynamicIfSql3",user);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            sqlSession.close();
    ...
    public void bynamicUpdateSql(){
        ...
        int ru = 0;
        try {
            ru = sqlSession.update("UserMapper.bynamicUpdateSql",user);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            sqlSession.close();
    ...
    public void dynamicForEachSql(){
        ...
        list.add(2);
        try {
            userList = sqlSession.selectList("UserMapper.dynamicForEachSql",list);
        }catch (Exception e){
            e.printStackTrace();
        }finally {
            sqlSession.close();
